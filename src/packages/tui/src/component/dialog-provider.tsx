...
const FREE_TIER_PROVIDERS = ["opencode", "google", "groq", "openrouter"]
    ...
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          ...
          google: "Free tier via /signin",
        }[provider.id],
        category: FREE_TIER_PROVIDERS.includes(provider.id) ? "Free Tier" : provider.id in PROVIDER_PRIORITY ? "Popular" : "Providers",
      })),
    ),
    {
      type: "custom",
